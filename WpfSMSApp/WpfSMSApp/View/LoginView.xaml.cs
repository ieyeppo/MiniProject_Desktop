...
namespace WpfSMSApp.View
{
    ...
    public partial class LoginView : MetroWindow
    {
        ...
        {
            var result = await this.ShowMessageAsync("종료", "프로그램을 종료하시겠습니까?", MessageDialogStyle.AffirmativeAndNegative, null);
        ...
        private async void BtnLogin_Click(object sender, RoutedEventArgs e)
        {
            ...
            if(string.IsNullOrEmpty(TxtUserEmail.Text) || string.IsNullOrEmpty(TxtPassword.Password))
            {
                ...
                LblResult.Content = "아이디나 비밀번호를 입력하세요.";
            ...
            try
            {
                ...
                var mdHash = MD5.Create();//Commons.SYS_HASH
